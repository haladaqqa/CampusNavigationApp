...
/**
 * This class is responsible for testing the User class methods.
 * 
 * @author nourfayadh
 */
public class UserTest {
    ...
    /**
     * Runs once before all test methods. Used to perform set up activities required for all tests.
     */
    @BeforeAll
    ...
    /**
     * Runs once after all test methods. Used to perform clean up activities required for all tests.
     */
    @AfterAll
    ...
    /**
     * Runs before each test method. Used to perform set up activities required for each test.
     */
    @BeforeEach
    public void setUp() {
    }
    ...
    /**
     * Runs after each test method. Used to perform clean up activities required for each test.
     */
    @AfterEach
